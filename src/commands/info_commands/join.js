...
module.exports = function run (guild, config)
{
   ...
   */
   ...
   return defaultChannel.send(`Greetings, I'm Missandei. Thank you for the opportunity to serve as your translator.`);
};
...
module.exports.newBot = function newBot (data)
{
   ...
   data.message.channel.send({"embed": {
      "color": 9514728,
      "description": "Let's get started:\nMissandei supports a few different methods of translations.\n**‏‏‎ ‎‎‎‎‎‎**",
      "fields": [
         {
      ...
      "title": "Kirimvose syt gaomagon Missandei."
   }});
